...
* **Themes**: Forest (Stage 1), Rice Field (Stage 2), Rainy Forest & Boss Arena (Stage 3)
...
1. Clone this repository:
   ...
   cd <repo-name>
   ```
2. Open Godot, click **Import**, select `project.godot` inside this folder, and click **Import & Edit**.
3. Press **F5** to start playing from the main menu.
...
### Quick Debug Keys:
* `1` / `2` / `3`: Jump to Stage 1, Stage 2, or Stage 3
